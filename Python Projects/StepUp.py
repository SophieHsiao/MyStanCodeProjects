...
def turn_right():
    """
    Since "turn right" isn't defined in python, we need to define this instruction, using "for i in range(3)", which means
    repeating the following instruction for three times.
    """
    for i in range(3):
        turn_left()
